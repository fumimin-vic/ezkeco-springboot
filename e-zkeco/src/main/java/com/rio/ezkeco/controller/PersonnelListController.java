...
import com.rio.ezkeco.service.PersonnelListService;
 ...
 */
@RestController
@RequestMapping("/api/personnelList")
public class PersonnelListController extends ExportExcelController{

    @Autowired
    PersonnelListService service;
    ...
    public ResultMsg selectPersonnelList(HttpServletResponse response, @RequestBody UserAccessSchema schemaParam) throws IOException {
//        System.out.println(schemaParam.getId());

        List list =  service.getPersonnelListAccess(schemaParam);
